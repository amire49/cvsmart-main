...
export default function ProfileLoading() {
  return (
    <div className="app-page min-h-screen bg-background overflow-hidden">
      <div className="absolute top-0 left-0 w-1/2 h-1/2 bg-primary rounded-full filter blur-[150px] opacity-20 animate-pulse" />
      <div className="absolute bottom-0 right-0 w-1/3 h-1/3 bg-success rounded-full filter blur-[150px] opacity-20 animate-pulse" />
